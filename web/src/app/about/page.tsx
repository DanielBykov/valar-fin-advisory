...
export default function AboutPage() {
  return (
    <div className="w-full flex flex-col font-sans">
      ...
      {/* ── 1. HERO ─────────────────────────────────────────────── */}
      <section className="relative min-h-[80vh] flex items-end overflow-hidden bg-[#061634]">
        <div className="absolute inset-0 z-0">
          <Image src="/images/lena-portrait.png" alt="Lena Bykova" fill className="object-cover object-top opacity-40" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#061634]/95 via-[#061634]/70 to-[#061634]/30" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#061634]/80 via-transparent to-transparent" />
        </div>
        <div className="container mx-auto px-4 md:px-6 relative z-10 pb-20 pt-32 max-w-5xl">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeIn} className="mb-5 space-y-3">
              ...
              <span className="text-[#8F93B5] font-bold tracking-widest text-xs uppercase">About Valar</span>
            </motion.div>
            <motion.h1 variants={fadeIn} className="text-4xl md:text-6xl font-bold text-white mb-5 leading-[1.05] max-w-3xl">
              Financial Advice Built Around Your Future<span className="text-[#E8A23A]">.</span>
            </motion.h1>
            <motion.p variants={fadeIn} className="text-xl text-[#C8CBE3] max-w-xl leading-relaxed border-l-2 border-[#E8A23A] pl-4 font-light mb-10">
              Helping Kiwi people make smarter property and financial decisions with clarity.
            </motion.p>
            <motion.div variants={fadeIn}>
              <Link href="/book" className="inline-flex items-center gap-2 bg-[#E8A23A] hover:bg-[#d4922e] text-[#061634] px-8 py-4 rounded-sm font-bold transition-colors">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-[#E8A23A] text-[#061634] font-bold text-sm px-4 py-2 rounded-sm shadow">
            ...
            <motion.div variants={stagger}>
              <motion.div variants={fadeIn} className="mb-3">
                <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Meet Lena</span>
              </motion.div>
              <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634] mb-2">
                Hi, I&apos;m Lena<span className="text-[#E8A23A]">.</span>
              </motion.h2>
              <motion.p variants={fadeIn} className="text-[#2E4882] font-medium text-sm mb-6">
              ...
              <motion.div variants={stagger} className="flex flex-wrap gap-2">
                {["20+ Years Finance Experience", "New Zealand Based", "Level 5 Qualified", "FundSmart Adviser", "Property Investor"].map((badge, i) => (
                  <motion.span key={i} variants={fadeIn} className="bg-[#F6F7F9] border border-[#C9CED6] text-[#061634] text-xs font-semibold px-3 py-1.5 rounded-full">
                    {badge}
                  </motion.span>
                ))}
              </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">What I Help Clients Think Through</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634] mb-4">
              Beyond Mortgage Approval<span className="text-[#E8A23A]">.</span>
            </motion.h2>
            <motion.p variants={fadeIn} className="text-[#2E4882] text-lg max-w-xl">
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="bg-white p-7 rounded-lg border border-[#C9CED6] shadow-sm">
                <div className="w-10 h-10 rounded-full bg-[#061634] flex items-center justify-center mb-4">
      ...
      <section className="py-24 bg-[#061634] text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">The Valar Formula</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold mb-3">
              Wealth is not built from money alone<span className="text-[#E8A23A]">.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            {["Clarity", "Strategy", "Discipline", "Time"].map((word, i, arr) => (
              <span key={i} className="flex items-center gap-3">
                <span className="bg-[#2E4882] border border-[#E8A23A]/30 text-white font-bold text-lg px-6 py-3 rounded-sm">{word}</span>
                {i < arr.length - 1 && <span className="text-[#E8A23A] text-2xl font-light">+</span>}
              </span>
            ))}
            <span className="text-[#E8A23A] text-2xl font-light mx-1">=</span>
            <span className="bg-[#E8A23A] text-[#061634] font-bold text-lg px-6 py-3 rounded-sm">Financial Freedom</span>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="bg-[#2E4882] p-6 rounded-sm border-t-2 border-[#E8A23A]">
                <h3 className="font-bold text-[#E8A23A] mb-3">{card.word}</h3>
          ...
          <motion.div
            initial="hidden" whileInView="visible" viewport={{ once: true }}
            variants={fadeIn}
            className="border-l-2 border-[#E8A23A] pl-6 max-w-2xl mx-auto"
          >
            <p className="text-[#C8CBE3] leading-relaxed">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={stagger}>
              <motion.div variants={fadeIn} className="mb-4">
                <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Real Experience, Not Just Theory</span>
              </motion.div>
              <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634] mb-6 leading-tight">
                I Build Wealth Differently Too<span className="text-[#E8A23A]">.</span>
              </motion.h2>
              <motion.p variants={fadeIn} className="text-[#2E4882] leading-relaxed mb-4">
              ...
              <motion.p variants={fadeIn} className="text-[#061634] font-semibold leading-relaxed">
            ...
            <motion.div variants={fadeIn} className="relative">
              ...
              />
              <div className="absolute -bottom-4 -left-4 bg-[#061634] text-white text-xs font-semibold px-4 py-2 rounded-sm shadow border-l-2 border-[#E8A23A]">
      ...
      <section className="py-24 bg-[#F6F7F9]">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Experience Snapshot</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634]">
              Experience You Can Trust<span className="text-[#E8A23A]">.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="bg-white p-5 rounded-lg border border-[#C9CED6] shadow-sm flex flex-col items-center text-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#061634] flex items-center justify-center">
                  <item.icon className="w-4 h-4 text-[#E8A23A]" />
                </div>
                <span className="text-[#061634] text-sm font-semibold leading-snug">{item.label}</span>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.p
            initial="hidden" whileInView="visible" viewport={{ once: true }}
            variants={fadeIn}
            className="text-[#2E4882] text-sm leading-relaxed border-l-2 border-[#E8A23A] pl-4 max-w-2xl"
          >
      ...
      <section className="py-24 bg-[#061634] text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">How Valar Is Different</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold">
              A Different Kind of Mortgage Adviser<span className="text-[#E8A23A]">.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            <motion.div variants={fadeIn} className="bg-[#2E4882]/50 border border-white/10 p-8 rounded-lg">
              <h3 className="font-bold text-[#8F93B5] mb-6 uppercase tracking-wider text-sm">Typical Mortgage Advice</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-[#8F93B5] text-sm">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#8F93B5]/50 flex-shrink-0 mt-1.5" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <motion.div variants={fadeIn} className="bg-[#2E4882] border border-[#E8A23A]/30 p-8 rounded-lg">
              <h3 className="font-bold text-[#E8A23A] mb-6 uppercase tracking-wider text-sm">The Valar Approach</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-white text-sm">
                    <CheckCircle2 className="w-4 h-4 text-[#E8A23A] flex-shrink-0 mt-0.5" />
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Qualifications</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634]">
              Qualifications &amp; Professional Development<span className="text-[#E8A23A]">.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="flex items-start gap-3 bg-[#F6F7F9] border border-[#C9CED6] p-5 rounded-lg">
                <Award className="w-4 h-4 text-[#E8A23A] flex-shrink-0 mt-0.5" />
                <span className="text-[#061634] text-sm font-medium leading-snug">{qual}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-[#F6F7F9]">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            ...
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold text-[#061634]">
              Our Process<span className="text-[#E8A23A]">.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            ...
            <div className="hidden md:block absolute left-[28px] top-8 bottom-8 w-px bg-[#C9CED6]" />
            <div className="space-y-6">
              {[
                ...
                <motion.div key={i} variants={fadeIn} className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-[#061634] text-[#E8A23A] font-bold text-sm flex items-center justify-center flex-shrink-0 border-2 border-[#E8A23A] relative z-10">
                    {step.num}
                  </div>
                  <div className="bg-white border border-[#C9CED6] rounded-lg p-6 flex-1 shadow-sm">
                    <h3 className="font-bold text-[#061634] mb-1">{step.title}</h3>
                    <p className="text-[#2E4882] text-sm leading-relaxed">{step.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-24 bg-[#2E4882] text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            <motion.div variants={stagger}>
              <motion.div variants={fadeIn} className="mb-4">
                <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Beyond Finance</span>
              </motion.div>
              <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold mb-6">
                Beyond Finance<span className="text-[#E8A23A]">.</span>
              </motion.h2>
            ...
            <motion.div variants={stagger} className="grid grid-cols-2 gap-3">
              {[
                ...
                <motion.div key={i} variants={fadeIn} className="bg-[#061634]/30 border border-white/10 p-4 rounded-sm flex items-center gap-3">
                  <item.icon className="w-4 h-4 text-[#E8A23A] flex-shrink-0" />
                  <span className="text-[#C8CBE3] text-sm">{item.label}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
      ...
      {/* ── 11. LICENSING ───────────────────────────────────────── */}
      <section className="py-16 bg-[#061634] border-t border-white/10">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <motion.div
            initial="hidden" whileInView="visible" viewport={{ once: true }}
            variants={stagger}
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Licensing &amp; Disclosure</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-xl font-bold text-white mb-5">
              Licensing &amp; Disclosure<span className="text-[#E8A23A]">.</span>
            </motion.h2>
            <motion.p variants={fadeIn} className="text-[#8F93B5] text-sm leading-relaxed mb-4 max-w-2xl">
            ...
            <motion.div variants={stagger} className="flex flex-wrap gap-4 mb-6">
              {[
                ...
                <motion.div key={i} variants={fadeIn}>
                  <Link href={link.href} className="inline-flex items-center gap-1.5 text-[#C8CBE3] hover:text-[#E8A23A] text-sm transition-colors">
                    <FileText className="w-3.5 h-3.5" /> {link.label} <ExternalLink className="w-3 h-3 opacity-50" />
                  </Link>
                </motion.div>
              ))}
            </motion.div>
            <motion.div variants={fadeIn} className="bg-[#2E4882]/40 border border-white/10 rounded-sm p-4 max-w-2xl">
              <p className="text-[#8F93B5] text-xs leading-relaxed">
                <span className="text-[#E8A23A] font-semibold">Note:</span> This section must be reviewed and approved by FundSmart before launch.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* ── 12. FINAL CTA ───────────────────────────────────────── */}
      <section className="py-24 bg-[#061634] text-white text-center border-t border-white/10">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4 flex justify-center">
              <span className="text-[#E8A23A] font-bold tracking-widest text-xs uppercase">Take the First Step</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
              Ready to Make Your Next Financial Step With Clarity<span className="text-[#E8A23A]">?</span>
            </motion.h2>
