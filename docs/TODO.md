...
- [ ] Testimonials — currently placeholder on home. Hide or clearly mark until real quotes arrive
- [ ] About page — handoff specifies 12 sections, current build is partial. Build out full layout from `about.md`
