# Valar FAQ — source of truth

FOR LENA: this file *is* the FAQ page. Edit it here, save, refresh the site.
There is no second copy to keep in sync.

How to write an entry:

    ## Category Name              <- a category heading. Order here = order on the page.

    ### The question?             <- one question
    status: approved              <- approved = live on the site. draft = only you see it, on localhost.
    services: mortgage-advice     <- optional, comma separated. Used later to feed service pages.
    review: 2026-11-17            <- optional. Use it whenever the answer contains a number that
                                     goes stale. Shows as a badge on localhost only, never public.

    The answer. Plain paragraphs.
...
status: approved
services: mortgage-advice, first-home-buyers
...
### Why speak with an adviser if I do not have pre-approval yet?
status: approved
...
status: approved
services: first-home-buyers, mortgage-advice
...
### Where is my deposit allowed to come from?
status: approved
services: first-home-buyers, mortgage-advice
...
### Why do two banks lend me different amounts?
status: approved
...
### What is a servicing test and why is the rate higher than the rate I will pay?
status: approved
services: mortgage-advice
review: 2026-11-17
...
### Do I need pre-approval before I start looking for a property?
status: approved
services: first-home-buyers, mortgage-advice
...
### Do I need a signed offer before applying for a mortgage?
status: approved
services: mortgage-advice
...
### Do you help me find investment properties?
status: approved
services: investment-property-analysis
...
### Is this suitable if I only have one investment property?
status: approved
services: investment-property-analysis
...
### Can you help if I am self-employed or have non-standard income?
status: approved
services: mortgage-advice, small-business-loans
...
### Can you help if my bank has declined my business application?
status: approved
...
### What can business lending be used for?
status: approved
services: small-business-loans
...
### What information will I need to provide for business lending?
status: approved
services: small-business-loans
...
### Do you provide business valuation services?
status: approved
services: small-business-loans
...
### Is financial planning separate from mortgage advice?
status: approved
services: financial-planning
...
### Do I need a large income or existing investments?
status: approved
services: financial-planning
...
### Can financial planning help me prepare to buy a home?
status: approved
services: financial-planning
