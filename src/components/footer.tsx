      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          ...
          <div data-cmp="Footer.Brand">
            <div className="mb-4">
              <Image src="/images/logo-white.webp" alt="Valar Financial Advisors" width={180} height={60} className="object-contain -mt-2 -ml-3" style={{ height: "auto" }} />
            </div>
          ...
          <div data-cmp="Footer.AboutLinks">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/disclosure" className="hover:text-white transition-colors">Disclosure Statement</Link></li>
            </ul>
          </div>
        </div>
